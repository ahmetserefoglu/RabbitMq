          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="sidebar-scrollbar">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class=" {{  request()->routeIs('home.slider') ||
                request()->routeIs('home.about') ||
                  request()->routeIs('multi.image') ||
                  request()->routeIs('all.brand')
                  ? 'has-sub active expand' : '' }}">
                    ...
                    <ul  class="{{  request()->routeIs('home.slider') ||
                request()->routeIs('home.about') ||
                  request()->routeIs('multi.image') ||
                  request()->routeIs('all.brand')
                  ? 'collapse show' : 'collapse' }}"  id="dashboard"
                      data-parent="#sidebar-menu">
                      <div class="sub-menu">



  <li  class="{{request()->routeIs('home.slider')  ? 'active ' : '' }}" >
  ...
  <li  class="{{ request()->routeIs('all.brand') ? 'active ' : '' }}" >
    <a class="sidenav-item-link" href="{{ route('all.brand') }}">
      <span class="nav-text">Home Brand</span>
                  ...
                  <li  class=" {{  request()->routeIs('admin.contact') || request()->routeIs('admin.message')  ? 'has-sub active expand' : '' }}">
                    <a class="sidenav-item-link {{  request()->routeIs('admin.contact') || request()->routeIs('admin.message')  ? ' ' : 'collapsed' }}" href="javascript:void(0)" data-toggle="collapse" data-target="#ui-elements"
                      aria-expanded="{{  request()->routeIs('admin.contact') || request()->routeIs('admin.message')  ? 'true ' : 'false' }}" aria-controls="ui-elements">
                      <i class="mdi mdi-folder-multiple-outline"></i>
                      <span class="nav-text">Contact Page</span> <b class="caret"></b>
                    </a>
                    <ul  class="{{  request()->routeIs('admin.contact') || request()->routeIs('admin.message')  ? 'collapse show' : 'collapse' }}"  id="ui-elements"
                      data-parent="#sidebar-menu">
                      <div class="sub-menu">
